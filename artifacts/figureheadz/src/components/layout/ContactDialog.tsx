  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="comic-border sm:rounded-none">
        <DialogHeader>
          <DialogTitle className="font-display text-3xl uppercase text-slate-100 [text-shadow:-2px_-2px_0_#000,2px_-2px_0_#000,-2px_2px_0_#000,2px_2px_0_#000]">Get In Touch</DialogTitle>
          <DialogDescription>
