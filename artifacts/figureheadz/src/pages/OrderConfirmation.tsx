    ...
    <div className="container mx-auto px-4 py-12 max-w-3xl">
      <div className="bg-sky-200 p-8 md:p-12 comic-border shadow-[12px_12px_0_#000] relative overflow-hidden">
        ...
        <div className="text-center mb-10">
          <div className="inline-block bg-secondary font-display text-2xl tracking-widest px-6 py-2 comic-border transform -rotate-2 mb-4 shadow-[4px_4px_0_#000] text-white [text-shadow:-2px_-2px_0_#000,2px_-2px_0_#000,-2px_2px_0_#000,2px_2px_0_#000]">
            SUCCESS!
          </div>
